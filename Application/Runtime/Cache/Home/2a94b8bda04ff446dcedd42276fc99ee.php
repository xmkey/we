...
<link rel="stylesheet" href="/personal/xmkey/we/Public/css/main.css">
...
<div class="app-loading">
    <!-- <img src="/personal/xmkey/we/Public/img/loading.gif" width="20"> -->
...
<section class="page-facade guest-pop hide">
  <section class="page-content">
    ...
    <div class="outer" id="slider">
      <ul class="u_sper">
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_01.jpg" width="150px" height="150px">
          <div class="info">
            <h3>Martin Nowak</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img1.png" width="280px"> -->
        </div>
        </li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_02.jpg" width="150px" height="150px">
          <div class="info">
            <h3>Bob Richards</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img2.png" width="280px"> -->
        </div></li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_03.jpg" width="150px" height="150px">
          <div class="info">
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img3.png" width="280px"></div> -->
        </li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_04.jpg" width="150px" height="150px">
          <div class="info">
            <h3>Jose Carmena</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img4.png" width="280px"></div> -->
        </li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_05.jpg" width="150px" height="150px">
          <div class="info">
            <h3>Jane Poynter</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img5.png" width="280px"></div> -->
        </li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_06.jpg" width="150px" height="150px">
          <div class="info">
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img6.png" width="280px"> -->
        </div></li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_07.jpg" width="150px" height="150px">
          <div class="info">
            <h3>苏运升</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img7.png" width="280px"> -->
        </div></li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_08.jpg" width="150px">
          <div class="info">
            <h3>王俊</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img8.png" width="280px"> -->
        </div></li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_09.jpg" width="150px">
          <div class="info">
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img9.png" width="280px"> -->
        </div></li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_10.jpg" width="150px">
          <div class="info">
            <h3>Ben Waber</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img10.png" width="280px"> -->
        </div></li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_11.jpg" width="150px">
          <div class="info">
            <h3>王阳</h3>
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img11.png" width="280px"> -->
        </div></li>
        <li><div class="imgbox">
          <img data-src="/personal/xmkey/we/Public/pic/guest_img_12.jpg" width="150px">
          <div class="info">
          ...
          <!-- <img data-src="/personal/xmkey/we/Public/pic/pop_img12.png" width="280px"> -->
        </div></li>
      </ul>
    </div>
